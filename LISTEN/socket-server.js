...
// var http = require("http").Server(app);  //WORKS
var http = require("http").createServer(app);  //WORKS

// var io = require("socket.io")(http);  //WORKS
var io = require("socket.io").listen(http);  //WORKS
