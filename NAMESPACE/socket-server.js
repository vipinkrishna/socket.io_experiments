...
var namespaceone = io.of("/namespaceone");

namespaceone.on("connect", function (socket) {
    console.log("CONNECTED ++");
    namespaceone.emit("hione", { msg: "HELLO EVERYONE!" });
...
var namespacetwo = io.of("/namespacetwo");

namespacetwo.on("connect", function (socket) {
    console.log("CONNECTED **");
    namespacetwo.emit("hitwo", { msg: "HELLO EVERYBODY!" });
